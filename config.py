...
# Dataset (choose one).
desc += '-prog_gan_128_svbrdf';            dataset = EasyDict(tfrecord_dir='prog_gan_128_svbrdf'); train.mirror_augment = True
...
desc += '-preset-v2-2gpus'; num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {512: 0.0015, 1024: 0.002}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 10000
